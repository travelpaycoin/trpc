Contributing to Trpc Core
============================

The Trpc Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Trpc Core project, and is not to be
confused with overall Trpc Network Protocol consensus changes.

Whether a pull request is merged into Trpc Core rests with the project merge
...
Patches that change Trpc consensus rules are considerably more involved than
...
Where a patch set proposes to change the Trpc consensus, it must have been
...
The project leader is the release manager for each Trpc Core release.
