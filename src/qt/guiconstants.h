...
/* trpc GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "TRPC"
#define QAPP_ORG_DOMAIN "trpc-coin.com"
#define QAPP_APP_NAME_DEFAULT "Trpc-Qt"
#define QAPP_APP_NAME_TESTNET "Trpc-Qt-testnet"
