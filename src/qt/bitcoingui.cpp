                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Trpc Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Trpc address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and trpc: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for xTRPC"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Trpc Core"), this);
    aboutAction->setStatusTip(tr("Show information about Trpc Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TRPC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Trpc addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Trpc addresses"));
    ...
    openAction->setStatusTip(tr("Open a TRPC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Trpc Core help message to get a list with possible Trpc command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Trpc Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Trpc network", "", count));
}
...
{
    QString strTitle = tr("Trpc Core"); // default title
