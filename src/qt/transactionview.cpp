 ...
 */
    ...
    typeWidget->addItem(tr("Received Trpc from xTRPC"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in xTRPC"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_xTRPC));
