...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Trpc features */
        {"trpc", "masternode", &masternode, true, true, false},
        {"trpc", "listmasternodes", &listmasternodes, true, true, false},
        {"trpc", "getmasternodecount", &getmasternodecount, true, true, false},
        {"trpc", "masternodeconnect", &masternodeconnect, true, true, false},
        {"trpc", "masternodecurrent", &masternodecurrent, true, true, false},
        {"trpc", "masternodedebug", &masternodedebug, true, true, false},
        {"trpc", "startmasternode", &startmasternode, true, true, false},
        {"trpc", "createmasternodekey", &createmasternodekey, true, true, false},
        {"trpc", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"trpc", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"trpc", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"trpc", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"trpc", "getmasternodescores", &getmasternodescores, true, true, false},
        {"trpc", "mnbudget", &mnbudget, true, true, false},
        {"trpc", "preparebudget", &preparebudget, true, true, false},
        {"trpc", "submitbudget", &submitbudget, true, true, false},
        {"trpc", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"trpc", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"trpc", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"trpc", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"trpc", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"trpc", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"trpc", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"trpc", "checkbudgets", &checkbudgets, true, true, false},
        {"trpc", "mnsync", &mnsync, true, true, false},
        {"trpc", "spork", &spork, true, true, false},
        {"trpc", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"trpc", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
{
    return "> trpc-cli " + methodname + " " + args + "\n";
}
