...
class HTTPWorkItem : public HTTRPClosure
{
public:
...
static WorkQueue<HTTRPClosure>* workQueue = 0;
...
static void HTTPWorkQueueRun(WorkQueue<HTTRPClosure>* queue)
{
...
bool InitHTTPServer()
{
    ...
    workQueue = new WorkQueue<HTTRPClosure>(workQueueDepth);
    eventBase = base;
    eventHTTP = http;
    return true;
}
