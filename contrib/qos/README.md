...
This means one can have an always-on trpcd instance running, and another local trpcd/trpc-qt instance which connects to this node and receives blocks from it.
