...
RESOURCES += src/qt/trpc.qrc src/qt/trpc_locale.qrc

TRANSLATIONS += src/qt/locale/trpc_bg.ts \
                src/qt/locale/trpc_de.ts \
                src/qt/locale/trpc_en.ts \
                src/qt/locale/trpc_es.ts \
                src/qt/locale/trpc_fi.ts \
                src/qt/locale/trpc_fr.ts \
                src/qt/locale/trpc_it.ts \
                src/qt/locale/trpc_ja.ts \
                src/qt/locale/trpc_pl.ts \
                src/qt/locale/trpc_pt.ts \
                src/qt/locale/trpc_ru.ts \
                src/qt/locale/trpc_sk.ts \
                src/qt/locale/trpc_sv.ts \
                src/qt/locale/trpc_vi.ts \
                src/qt/locale/trpc_zh_CN.ts \
                src/qt/locale/trpc_zh_TW.ts
