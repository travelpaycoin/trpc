...
###   This script attempts to download the signature file SHA256SUMS.asc from trpccore.xyz
...
SIGNATUREFILE="https://trpccore.xyz/bin/3.0.4.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://trpccore.xyz/bin/"
