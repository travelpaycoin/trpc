...
In order to support loading of multiple wallets in trpc-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is trpc.cpp.
...
Changes to trpc.cpp
----------------------
trpc.cpp is the entry point into trpc-qt, and as such, will require some minor modifications to provide hooks for
