...
#   c) node1 mines 32 blocks, so now node 0 has 60001trpc, node 1 has 4250trpc, node2 has none.
#   d) node0 sends 601 trpc to node2, in two transactions (301 trpc, then 300 trpc).
